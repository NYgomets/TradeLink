...
public class CustomOidcUserService extends AbstractOAuth2UserService implements OAuth2UserService<OidcUserRequest, OidcUser> {
    ...
    public CustomOidcUserService(MemberService memberService, MemberRepository memberRepository, ProviderUserConverter<ClientRegistration, OAuth2User, ProviderUser> providerUserConverter) {
    ...
    public OidcUser loadUser(OidcUserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (clientRegistration.getRegistrationId().equals("kakao")) {
            ...
            userRequest = new OidcUserRequest(clientRegistration, userRequest.getAccessToken(), userRequest.getIdToken(), userRequest.getAdditionalParameters());
        }
